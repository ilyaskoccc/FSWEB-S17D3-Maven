...
public class KangarooController {
    ...
    public Kangaroo save(@RequestBody Kangaroo kangaroo) {
        ...
        ZooKangarooValidation.checkKangarooId(kangaroo.getId());
        ZooKangarooValidation.checkKangarooName(kangaroo.getName());
        ZooKangarooValidation.checkKangarooHeight(kangaroo.getHeight());
        ZooKangarooValidation.checkKangarooWeight(kangaroo.getWeight());
        ZooKangarooValidation.checkKangarooGender(kangaroo.getGender());
